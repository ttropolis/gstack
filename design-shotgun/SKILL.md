...
"$_SS" --skill "design-shotgun" --model "fable-5" --parent-pid "$PPID" \
...
tool with `subagent_type: "general-purpose"`, `model: "sonnet"` (mechanical variant
generation), and `run_in_background: false` for each
